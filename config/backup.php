...
return [
    ...
    'cleanup' => [
        ...
        'defaultStrategy' => [
            'keepAllBackupsForDays' => env('BACKUP_KEEP_ALL_BACKUPS_FOR_DAYS', 7),
            'keepDailyBackupsForDays' => env('BACKUP_KEEP_DAILY_BACKUPS_FOR_DAYS', 30),
            'keepWeeklyBackupsForWeeks' => env('BACKUP_KEEP_WEEKLY_BACKUPS_FOR_WEEKS', 12),
            'keepMonthlyBackupsForMonths' => env('BACKUP_KEEP_MONTHLY_BACKUPS_FOR_MONTHS', 6),
            'keepYearlyBackupsForYears' => env('BACKUP_KEEP_YEARLY_BACKUPS_FOR_YEARS', 2),
            'deleteOldestBackupsWhenUsingMoreMegabytesThan'
            => env('BACKUP_DELETE_OLDEST_WHEN_USING_MORE_MEGABYTES_THAN', 5000),
        ],
